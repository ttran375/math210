...
For full marks, provide detailed solutions. Complete questions 4, 5, and
6 using SCILAB. Late assignments submitted within 24 hours after the due
date will be penalized by 25%. After 24 hours, no assignments will be
accepted.

## 1. Solve the System of Linear Equations \[5 marks\]

A system of linear equations was reduced to the form below. Continue to
use Jordan-Gauss elimination to fully solve the system. Show all steps.
...
Use elementary row operations to solve the above system. Identify the
free variable(s) if any.
...
```
    ...
    ## [-61.33333333  42.          30.33333333  27.66666667]
...
```
    ...
    ## Solution for part (a) of Question 5:

``` python
print(x_a)
```

    ## [ 0.03735632 -0.12212644  0.1795977 ]
...
```
    ...
    ## Solution for part (b) of Question 5:

``` python
print(x_b)
```

    ## [ 0.2183908  -0.36781609  1.01149425]
