...
Since there are 6 data points (even number), the median is the average of the 3rd and 4th values:
...
The standard deviation measures the dispersion of the data points from the mean. It is calculated as follows:
