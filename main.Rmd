...
Since the minimum value (4) and the maximum value(49) fall within the range \([-6, 58]\), there are no mild outliers in this dataset. Since there are no mild outliers, there are also no severe outliers in this dataset.
...
To find the coefficient of correlation, we will use Pearson's correlation coefficient formula, which is given by:
...
- \( \sum X^2 \) is the sum of the squares of the X scores
- \( \sum Y^2 \) is the sum of the squares of the Y scores
